...
- Added optional `vertex_to_cells` override to `KDTreeSearch`, allowing custom point-location connectivity (for non-conforming meshes). Since PR[#1328](https://github.com/gridap/Gridap.jl/pull/1328).
