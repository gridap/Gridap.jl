...
writevtk(p1,"tmp/p1";append=false)
writevtk(p2,"tmp/p2";append=false)
writevtk(p,"tmp/p";append=false)
writevtk(q,"tmp/q";append=false)
...
writevtk(Triangulation(model),"tmp/model";append=false)
