...
@test ODEs._tableau_type(matrix) == ODEs.FullyImplicitTableau
...
@test ODEs._tableau_type(matrix) == ODEs.DiagonallyImplicitTableau
...
@test ODEs._tableau_type(matrix) == ODEs.ExplicitTableau
