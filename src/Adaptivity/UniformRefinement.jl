...
function _uniformly_refine_grid_topology(
	...
	coords = _uniformly_coordinates(cell_ref_coords, cell_l2g, cell_map, n_nodes)
	conn = _uniformly_connectivity(cell_ref_conns, cell_l2g, n_cells)
	...
	if num_vertices(ctopo) != num_nodes(cgrid)
		...
		grid_coords = _uniformly_coordinates(cell_ref_coords, grid_cell_l2g, cell_map, grid_n_nodes)
		grid_conn = _uniformly_connectivity(cell_ref_conns, grid_cell_l2g, n_cells)
	else
