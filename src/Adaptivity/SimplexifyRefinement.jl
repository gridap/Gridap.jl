...
function refine(::SimplexifyRefinement,model::CartesianDiscreteModel{Dc,Dp};kwargs...) where {Dc,Dp}
  _simplex_refine(model;kwargs...)
end
...
function _simplex_refine(model::DiscreteModel{Dc,Dp};kwargs...) where {Dc,Dp}
