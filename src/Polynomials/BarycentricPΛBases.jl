...
const PΛBases = Union{BarycentricPmΛBasis, BarycentricPΛBasis}
...
get_order(b::PΛBases) = b.r

"""
    print_indices(b::P(m)LambdaBasis, out=stdout)

Prints the indices of the given PΛ basis in `out` in a user friendly format.
"""
print_indices(b::PΛBases, out=stdout) = show(out, MIME"text/plain"(), b._indices)
