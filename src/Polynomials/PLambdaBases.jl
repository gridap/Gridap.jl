...
function _check_PΛ_indices(r,k,D,F,DG_style, indices::PLambdaIndices, rot_90)
  @check F ∈ (:P,:P⁻)
...
function _generate_or_check_PmΛ_indices(r,k,D,DG_style,indices::PLambdaIndices,rot_90)
...
function _generate_or_check_PΛ_indices(r,k,D,DG_style,indices::PLambdaIndices,rot_90)
  _check_PΛ_indices(r,k,D,:P,DG_style,indices,rot_90)
  return indices
end
